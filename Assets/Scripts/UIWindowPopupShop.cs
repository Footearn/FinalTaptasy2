...
public class UIWindowPopupShop : UIWindow
{
	public static UIWindowPopupShop instance;
	...
	public void openShopPopupWithType(ShopManager.ShopSelectedType targetSelectType)
	{
	...
	public void OnClickOpenShopPopupWithType(int type)
	{
		openShopPopupWithType((ShopManager.ShopSelectedType)type);
	}
